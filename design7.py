...
class Ui_MainWindow7(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(1264, 708)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(0, 0, 1273, 710))
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("form7.png"))
        ...
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(660, 170, 561, 471))
        self.label.setStyleSheet("background-color: transparent; color: white;")
        self.label.setObjectName("label")
        pixmap = QtGui.QPixmap("gr5.png")
