...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
         ...
         self.label.setText("")
         self.label.setPixmap(QtGui.QPixmap("form1.png"))
         ...
         self.textEdit_3.setPlaceholderText("Введіть ім'я")
         ...
         self.textEdit.setPlaceholderText("Введіть прізвище")
         ...
         self.textEdit_4.setPlaceholderText("Введіть пароль")
         ...
         self.textEdit_2.setPlaceholderText("Введіть логін")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "СТВОРИТИ АКАУНТ"))
