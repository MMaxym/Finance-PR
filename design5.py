...
class Ui_MainWindow5(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(1273, 710)
        icon = QtGui.QIcon()
        ...
        self.label.setText("")
        self.label.setPixmap(QtGui.QPixmap("form5.png"))
        self.label.setObjectName("label")
        self.pushButton_3 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_3.setGeometry(QtCore.QRect(510, 610, 251, 21))
        font = QtGui.QFont()
        ...
        self.textEdit_3.setPlaceholderText("Введіть кількість")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(510, 520, 251, 21))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.pushButton_4.setFont(font)
        self.pushButton_4.setStyleSheet("background-color: transparent; color: white;")
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(510, 550, 251, 51))
        font = QtGui.QFont()
        font.setPointSize(13)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Обрахувати"))
